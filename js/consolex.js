...
// 示例调试函数
function radio1Func1() {
    console.log('选择了 Huey');
}

function radio1Func2() {
    console.log('选择了 Dewey');
}

function radio1Func3() {
    console.log('选择了 Louie');
}
...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    settingRadioBinding('drone', '11111');
...
function settingInfo() {
    ...
    function getBrowserAndOS() {
        ...
        /*if (userAgent.includes("Chrome")) {
            ...
            browserName = "QQ";
        } else if (userAgent.includes("Sougou")) {
            browserName = "搜狗";
        } else {
            browserName = "Others"
        }
        ...
        // 调整顺序，优先检测移动端
        if (/OpenHarmony/i.test(userAgent)) {
          osName = "OpenHarmony";
        } else if (/HarmonyOS|HMOS/i.test(userAgent)) {
          // 检测是否为安卓底层的鸿蒙系统（如华为EMUI升级版）
          if (/Android/i.test(userAgent)) {
            osName = "HarmonyOS";
          } else {
            // 原生鸿蒙系统（如智慧屏等设备）
            osName = "HarmonyOS NEXT";
          }
